...
fun EntryDetailScreen(navController: NavHostController, journalViewModel: JournalViewModel, entryId: String) {
    ...
    // Fallback to a sample if not found
    val displayEntry = entry ?: createFallbackEntry()
    ...
    Scaffold(
        ...
        Column(modifier = Modifier
            ...
            Text(text = displayEntry.title ?: "Untitled Entry", style = MaterialTheme.typography.headlineLarge)
...
private fun createFallbackEntry(): JournalEntry {
    return JournalEntry(
        id = "fallback",
        ...
        transcript = Transcript(
            ...
            recordingSessionId = "session-fallback",
            fullText = "This entry could not be loaded."
        ),
        tags = emptyList(),
        moodAnalysis = null
    )
